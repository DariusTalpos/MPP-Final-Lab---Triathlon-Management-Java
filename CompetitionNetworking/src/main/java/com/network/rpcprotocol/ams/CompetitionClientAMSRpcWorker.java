package com.network.rpcprotocol.ams;
...
import com.network.rpcprotocol.Request;
import com.network.rpcprotocol.RequestType;
import com.network.rpcprotocol.Response;
import com.network.rpcprotocol.ResponseType;
...
public class CompetitionClientAMSRpcWorker implements Runnable{
    ...
    public CompetitionClientAMSRpcWorker(ICompetitionServicesAMS server, Socket connection) {
        this.server = server;
