...
import com.network.rpcprotocol.*;
import com.services.CompetitionException;
import com.services.notification.ICompetitionClient;
...
public class CompetitionServerAMSRpcProxy implements ICompetitionServicesAMS {

    private String host;
    private int port;

    private ICompetitionClient client;
    ...
    public CompetitionServerAMSRpcProxy(String host, int port) {
        this.host = host;
        this.port = port;
